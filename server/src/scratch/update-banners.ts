...
const newBanners = [
  ...
  {
    desktopImage: '/images/banners/2.png', // Placeholder (Previous high-quality image)
  ...
  {
    desktopImage: '/images/banners/3.png', // Placeholder
  ...
  {
    desktopImage: '/images/banners/4.png', // Placeholder
...
async function updateBanners() {
  try {
    ...
    if (homepage) {
      homepage.banners = newBanners;
      await homepage.save();
      console.log('✅ Banners updated successfully with new content and logic.');
    } else {
      console.log('❌ Homepage document not found. Ensure "seo.slug: home" exists.');
    }
