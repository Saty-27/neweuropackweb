  ...
  return (
    <div className="pb-20">
      <div className="flex items-center gap-4 mb-10">
        ...
        <div>
          <h1 className="text-3xl font-black text-slate-900 tracking-tight">Post New Role</h1>
          <p className="text-slate-500 font-medium">Add a new career opportunity to the Europack ecosystem</p>
        </div>
      </div>
